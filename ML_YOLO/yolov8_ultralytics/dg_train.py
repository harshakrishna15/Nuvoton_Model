...
def parser_arguments():
    ...
    parser.add_argument('--batch', type=int, default=64, help='total batch size for all GPUs, -1 for autobatch')
    ...
    parser.add_argument('--save-period', type=int, default=-1, help='Save checkpoint every x epochs (-1 disables)')
    parser.add_argument(
        '--patience',
        type=int,
        default=30,
        help='EarlyStopping patience in epochs without improvement; use 0 to disable',
    )
