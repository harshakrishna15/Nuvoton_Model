...
def post_train_quant_convert(keras_model_file, annotation_file, sample_num, model_input_shape, output_file, output_format):
...
def main():
    ...
    parser.add_argument('--output_format', type=str, help='model quantization type, int8 or f32', default='f32')
    ...
    post_train_quant_convert(args.keras_model_file, args.annotation_file, args.sample_num, model_input_shape, args.output_file, args.output_format)
